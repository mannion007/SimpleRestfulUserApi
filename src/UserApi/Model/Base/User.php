...
use UserApi\Model\UserQuery as ChildUserQuery;
use UserApi\Model\Map\UserTableMap;
 ...
 *
 *
 * @package    propel.generator.UserApi.Model.Base
 */
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\UserApi\\Model\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of UserApi\Model\Base\User object.
     */
     ...
     * @return $this|\UserApi\Model\User The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserTableMap::translateFieldName('Updated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\UserApi\\Model\\User'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\UserApi\Model\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\UserApi\Model\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserApi\Model\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserApi\Model\User Clone of current object.
     * @throws PropelException
     */
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('email', new Length(array ('min' => 1,'max' => 200,)));
        $metadata->addPropertyConstraint('forename', new NotNull());
        $metadata->addPropertyConstraint('forename', new Length(array ('min' => 1,'max' => 100,)));
        $metadata->addPropertyConstraint('surname', new NotNull());
        $metadata->addPropertyConstraint('surname', new Length(array ('min' => 1,'max' => 100,)));
    }
