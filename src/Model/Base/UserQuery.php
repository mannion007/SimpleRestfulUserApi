...
use UserApi\Model\User as ChildUser;
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \UserApi\Model\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\UserApi\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, email, forename, surname, created, updated FROM user WHERE id = :p0';
        try {
